    ...
    <form action="{{ route('auth.store') }}" method="post" class="container">
        ...
        <div class="mb-3 row">
            <div class="col-12 col-md-6 mx-auto">
                ...
                @error('name')
                    <div class="bg-alert p-2 mt-2 rounded" id="error-name"><i class="fa-solid fa-circle-exclamation" class="text-danger"></i> {{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12 col-md-6 mx-auto">
                ...
                @error('surname')
                    <div class="bg-alert p-2 mt-2 rounded" id="error-surname"><i class="fa-solid fa-circle-exclamation" class="text-danger"></i> {{ $message }}</div>
                @enderror
            </div>
        </div>
        ...
        <div class="mb-3 row">
            <div class="col-12 col-md-6 mx-auto">
                ...
                @error('telephone')
                    <div class="bg-alert p-2 mt-2 rounded" id="error-telephone"><i class="fa-solid fa-circle-exclamation" class="text-danger"></i> {{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="mb-3 row">
            <div class="col-12 col-md-6 mx-auto">
                ...
                @error('address')
                    <div class="bg-alert p-2 mt-2 rounded" id="error-address"><i class="fa-solid fa-circle-exclamation" class="text-danger"></i> {{ $message }}</div>
                @enderror
            </div>
            <div class="col-12 col-md-6 mx-auto">
                ...
                @error('cuil')
                    <div class="bg-alert p-2 mt-2 rounded" id="error-cuil"><i class="fa-solid fa-circle-exclamation" class="text-danger"></i> {{ $message }}</div>
                @enderror
            </div>
        </div>
