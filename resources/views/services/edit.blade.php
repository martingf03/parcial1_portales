...
<x-layout>
    ...
    <div class="container">
        ...
        @endif
        <h1 class="mb-3 text-center">Editar servicio</h1>
        <div class="my-card p-4 custom-mq mx-auto">
            <form action="{{ route('services.update', ['id' => $service->id]) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input @error('category_id') is-invalid @enderror" type="radio"
                            name="category_id" id="category_id_software" value="1" {{ old('category_id', $service->category_id) == '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="category_id_software">Software</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input @error('category_id') is-invalid @enderror" type="radio"
                            name="category_id" id="category_id_hardware" value="2" {{ old('category_id', $service->category_id) == '2' ? 'checked' : '' }}>
                ...
                <div class="my-3 d-flex justify-content-center align-items-center gap-2">
                    <a href="{{ route('services') }}" class="btn btn-secondary">Volver</a>
